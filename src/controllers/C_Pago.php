...
function pago_view(...$args) { return payment_view(...$args); }
function pago_get_all(...$args) { return payment_get_all(...$args); }
function pago_add_many(...$args) { return payment_add_many(...$args); }
