...
if (count($url) < 2 || $url[1] === 'view') {
    if (file_exists(__DIR__ . '/../views/V_paquete_reservacion.php')) {
        ...
        make_url_error("No se encontró la vista V_paquete_reservacion.php", 404);
    }
    exit;
}
...
if ($url[1] === 'get_all') {
    ...
    try {
        $modelo = new Paquetes(id: $_POST['id']);
    ...
    make_url_error("Accion no valida para paquete_reservacion.", 404, ajax: true);
}
