...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-02-2026 a las 23:41:52
...
(78, 10, 'cocina', 'consultar,preparar,ver detalles'),
(79, 10, 'mesas', ''),
(80, 10, 'Materia prima', ''),
(81, 10, 'ordenes', 'consultar'),
(84, 10, 'estadisticas', ''),
(85, 10, 'capital', ''),
(86, 10, 'Papelera', ''),
(87, 10, 'Producto preparado', ''),
(88, 10, 'Entradas de materia prima', ''),
(89, 10, 'Recetas', ''),
(90, 10, 'Adicionales', ''),
(91, 10, 'Producto procesado', ''),
(92, 10, 'Entradas de productos procesados', ''),
(93, 10, 'proveedores', ''),
(94, 10, 'clientes', ''),
(95, 10, 'caja', ''),
(96, 10, 'categorias', ''),
...
(98, 10, 'usuarios', ''),
(99, 10, 'unidades', ''),
(101, 10, 'Mantenimiento', ''),
(103, 10, 'roles y permisos', ''),
...
(107, 10, 'Ordenes (local)', ''),
(108, 10, 'Ordenes (delivery)', 'consultar,verificar,anular,crear'),
(109, 10, 'Ordenes (llevar)', 'consultar,verificar,anular,despachar,crear'),
...
(112, 10, 'delivery', 'consultar,aceptar entrega'),
(113, 1, 'facturas', 'consultar'),
(114, 10, 'paquetes', ''),
(115, 10, 'reservaciones', ''),
(116, 10, 'facturas', ''),
(117, 10, 'Ordenes (reservas)', 'consultar,agregar productos'),
(118, 1, 'Ordenes (reservas)', 'consultar,agregar productos,pagar,despachar'),
(144, 12, 'mesas', 'consultar');
...
(1, 'Super Admin', 'Rol con acceso a todas las funciones del e-commerce', 1),
(10, 'Cocinero', 'Rol destinado a la preparacion de comida de Burger House', 1),
(12, 'Cajero', 'Rol destinado a la atencion de usuarios y recibir pagos en BurgerHouse', 1);
...
(13, 1, 'Pedro', 'Pedro25**', 'Perez', 0, '1', 'pedro202@gmail.com', 'token', NULL, ''),
(14, 1, 'Rolando', 'Martinez25/', 'Martinez', 1, 'eGb0Acm4SF', 'martinezj@gmail.com', 'token', NULL, ''),
(15, 10, 'Luis', 'Luisgv202*', 'Garnica', 1, '1', 'l4rius2002@gmail.com', 'token', NULL, '103327.jpg'),
(25, 1, 'Persona', '(Tocuyo#123)', 'Humana', 1, 'xy5RFnsH8i', 'yolokratos903@gmail.com', 'token', NULL, NULL);
